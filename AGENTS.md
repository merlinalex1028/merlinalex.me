...
| **Playwright** | E2E testing (per AGENTS.md testing rules) | Test critical flows: theme switch persistence, BGM resume, Live2D loads behind first paint, search returns results. |
| **Vitest** | Unit testing | Utility functions only (e.g., reading-time calc, slug generation). Test coverage 80%+ per AGENTS.md. |
